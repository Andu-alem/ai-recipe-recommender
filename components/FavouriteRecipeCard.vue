    ...
    >
        <CardHeader>
            <CardTitle class="flex justify-between items-center px-2">
                ...
                <DeleteRecipeButton :recipeId="recipe._id" @refetch="$emit('refetch')" />
            </CardTitle>
        </CardHeader>
        <CardContent class="space-y-4">
            ...
            <div class="space-y-2 text-sm">
                ...
                <p class="text-xs text-foreground/85">Your Ingredients : <span class="capitalize">{{ recipe.userIngredients }}</span></p>
            </div>
