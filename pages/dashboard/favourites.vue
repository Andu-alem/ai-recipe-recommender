                ...
                >
                    ...
                    <CardContent>
                        ...
                        <div class="flex flex-wrap gap-1 mb-3">
                            <Badge v-for="ingredient in recipe.ingredients" :key="ingredient" variant="secondary" class="text-xs bg-emerald-100 text-emerald-700">
                                {{ingredient}}
                            </Badge>
                        </div>
                        <div class="text-xs text-stone-500">You have: {{recipe.userIngredients}}</div>
                    </CardContent>
                </Card>
            </div>
        </div>
